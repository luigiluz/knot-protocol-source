...
#define UNIT_ACCELERATION_MASK	(UNIT_MASK(KNOT_UNIT_ACCELERATION_MS2))

#define UNIT_ANG_VEL_MASK	(UNIT_MASK(KNOT_UNIT_ANGULAR_VELOCITY_DEGSEG))
...
static const struct schema {
	...
	{KNOT_VALUE_TYPE_INT, UNIT_ACCELERATION_MASK	},
	{KNOT_VALUE_TYPE_FLOAT, UNIT_ANG_VEL_MASK}
};
